...
public class DB extends SQLiteOpenHelper {
    ...
    private static final String SQLdb = "CREATE TABLE amigos (idAmigo int primary key autoincrement, nombre text, direccion text, telefono text, email text, dui text)";
    ...
    public String administrar_amigo(String accion, String[] datos){
        try {
